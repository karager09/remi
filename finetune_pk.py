...
def main():
    ...
    with open(r'pickle/training_data_len256_classical_pickle_filtered_2from3ins_0,1err', 'rb') as file:
    ...
    ####################################
    output_checkpoint_folder = 'REMI-finetune-pk-len256-2from3ins_0,1err_anymeter' # your decision
